...
public class GingerbreadJSFix {
	...
	protected void fixWebViewJSInterface(WebView webview, Object jsInterface, String jsInterfaceName, String jsSignature) {
		...
		// Everything else is fine
			...
			webview.addJavascriptInterface((TeaseMeJavaScriptInterface) jsInterface, jsInterfaceName);
		}
	...
	private class GingerbreadWebViewChrome extends WebChromeClient {
		...
		public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
			...
			try {
				...
				Log.e(this.getClass().getPackage().getName(), "shouldOverrideUrlLoading: Please ensure your JSInterface methods only have String as parameters.");
